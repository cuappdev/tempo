...
class FeedViewController: UITableViewController, UIScrollViewDelegate {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        if (tableView.indexPathForSelectedRow() != nil){ //If a row is selected
            ...
            //println("lol")
            var selectedRow = tableView.indexPathForSelectedRow()! //Selected Row
            var rowsICanSee = tableView.indexPathsForVisibleRows()! //Rows Seen
            var cellSelected = tableView.cellForRowAtIndexPath(selectedRow)
